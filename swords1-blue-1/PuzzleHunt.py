...
def test_print_greeting(func):
  inputs = [[13], [16], [3], [7], [5], [12], [0], [20], [23]]
  outputs = ["Good afternoon", "Good evening", "Good night", "Good morning",
              "Good morning", "Good afternoon", "Good night", "Good night", "Good night"]
  if test_func(func, inputs, outputs):
      reverse_caesar_shift("ZCBSZM HOPZS CIHGWRS CT S TCIF", 14)
      return True
  return False